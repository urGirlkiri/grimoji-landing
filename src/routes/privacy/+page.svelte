...
<Palette class="min-h-screen bg-(--void-black) font-['Caudex'] text-(--moonlight)">
    ...
    <a href="/" class="text-(--mist) hover:text-(--true-white)">← Back to Home</a>
		...
		<ul class="space-y-2 mb-6 pl-4 leading-relaxed list-disc list-inside">
			...
			<li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to Grimoji.</li>
		...
		<h4 class="mb-2 mt-4 text-base font-semibold text-(--slate)">Personal Data</h4>
		<p class="mb-4 leading-relaxed">
			While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited to:
		</p>

		<h4 class="mb-2 mt-4 text-base font-semibold text-(--slate)">Usage Data</h4>
		<p class="mb-4 leading-relaxed">
		...
		<p class="mb-3 leading-relaxed">The Company may use Personal Data for the following purposes:</p>
		<ul class="space-y-2 mb-6 pl-4 leading-relaxed list-disc list-inside">
		...
		<p class="mb-3 leading-relaxed">We may share Your Personal Data in the following situations:</p>
		<ul class="space-y-2 mb-6 pl-4 leading-relaxed list-disc list-inside">
		...
		<h2 class="font-['Eagle Lake'] mb-4 mt-10 text-2xl font-semibold text-(--moonlight)">Retention of Your Personal Data</h2>
		<p class="mb-4 leading-relaxed">
		...
		<h3 class="mb-3 mt-6 text-lg font-semibold text-(--mist)">Retention Periods</h3>
		<ul class="space-y-2 mb-6 pl-4 leading-relaxed list-disc list-inside">
			<li><strong>Account Information:</strong> User Accounts retained for the duration of your account relationship plus up to 24 months after account closure.</li>
			<li><strong>Usage Data:</strong> Application usage statistics and server logs retained up to 24 months for security monitoring and troubleshooting purposes.</li>
		</ul>

		<p class="mb-4 leading-relaxed">
			We may retain Personal Data beyond the periods stated above for different reasons: legal obligation, legal claims, your explicit request, or technical limitations.
		</p>
		...
		<h2 class="font-['Eagle Lake'] mb-4 mt-10 text-2xl font-semibold text-(--moonlight)">Transfer of Your Personal Data</h2>
		<p class="mb-4 leading-relaxed">
		...
		<h2 class="font-['Eagle Lake'] mb-4 mt-10 text-2xl font-semibold text-(--moonlight)">Delete Your Personal Data</h2>
		<p class="mb-4 leading-relaxed">
		...
		<h2 class="font-['Eagle Lake'] mb-4 mt-10 text-2xl font-semibold text-(--moonlight)">Disclosure of Your Personal Data</h2>

		<h3 class="mb-3 mt-6 text-lg font-semibold text-(--mist)">Business Transactions</h3>
		<p class="mb-4 leading-relaxed">
			If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
		</p>

		<h3 class="mb-3 mt-6 text-lg font-semibold text-(--mist)">Law enforcement</h3>
		<p class="mb-4 leading-relaxed">
			Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
		</p>

		<h3 class="mb-3 mt-6 text-lg font-semibold text-(--mist)">Other legal requirements</h3>
		<p class="mb-3 leading-relaxed">The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:</p>
		<ul class="space-y-2 mb-6 pl-4 leading-relaxed list-disc list-inside">
